...
class msg_test5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "msg_test5")
        ...
        self.blocks_message_strobe_random_0 = blocks.message_strobe_random(pmt.intern("Testing"), blocks.STROBE_POISSON, 10000, 0)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_random_0, 'strobe'), (self.zeromq_push_msg_sink_0, 'in'))
